...
def _load_json_config(config_path: str) -> Any:
    """Load configuration from JSON file."""
    with open(config_path, 'r', encoding='utf-8') as f:
        return json.load(f)


def load_devices_config(config_path: str) -> Dict[str, str]:
    """Load devices configuration from JSON file."""
    return _load_json_config(config_path)


def load_apps_config(config_path: str) -> Dict[str, Dict[str, Any]]:
